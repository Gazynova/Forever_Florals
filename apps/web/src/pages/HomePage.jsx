...
import { Leaf, Award, Infinity as InfinityIcon } from "lucide-react";
...
function HomePage() {
  ...
  const categories = [
    {
      ...
      image: "https://lh3.googleusercontent.com/aida-public/AB6AXuA1xl4ksGPDgySSvcoD5VG0XzVmmie9AShsrrtBfaLEhukhqOjpxHcbpmmKTuVkTgXC4HSG6C9iDVjgNSEn3bQhFYmUZi1BKJkZ6CCYwDIxzEfBP3wlFSt3nW0dFntzxp0kQFMBmx-aS6v3YY7h3k-NbgRrpzVGXWP5bLKK-XZ2HYc30leDigyyRw4YSHltSnpPO4QGvhQ9mznHrvhqL9OIicf8Z3kxSkKb77LmXRH47p9mrXGaS9dSZegtUimBbxbsYXPFruVq8l3T",
    },
    {
    ...
    {
      name: "Candles",
      image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAKmhmrAjbmF56QVTVTGuSxGsxCNLecxDIMso6rci3SojrF5JjeWtZU76JVBNTUmje6N64dhlK6xaPamLa8LfnZ3yEpXyllb80vzGslAUGDUY-mnLj4W_nqz5RP81x4InrlmkmRCLeRPMHbB9wWhjljXQAb8QAQHi1_EGo1QM6nsNxUOM3HEMPpOUmAPyYRWwKE7Pb7QtZkeaoWwldXAurVZppDkDtRoLKVckW_aoMVD5G306O_qHnKgBD771VfKAPjkHE2sE6NH7Ij",
    },
    {
      name: "Wooden Décor",
  ...
  const bestSellers = [
    {
      name: "Crimson Eternal Rose",
      price: "32.00",
      image: "https://images.unsplash.com/photo-1511995248717-b416946df342",
    },
    {
      name: "Cotton Cloud Bouquet",
      price: "28.50",
      image: "https://images.unsplash.com/photo-1615595969149-c5caa6b49a3e",
    },
    {
      name: "Meadow Mist Candle",
      price: "24.99",
      image: "https://images.unsplash.com/photo-1615851907615-1b1dc3473aec",
    },
    {
      name: "Wild Harvest Oil Set",
      price: "45.00",
      image: "https://images.unsplash.com/photo-1543107077-10e79d5865ed",
    },
  ];
      ...
      <main className="flex-grow pt-20">
        ...
        <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            ...
            {/* Soft overlay (very important for premium feel) */}
        ...
        {/* NATURE'S ARTISTRY PRESERVED SECTION */}
        ...
        <section className="py-24 bg-card">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row justify-between items-end mb-12 gap-4 border-b border-border pb-6">
              <div>
                <h2 className="text-foreground mb-2">Best Sellers</h2>
                <p className="text-muted-foreground text-lg">
                  Loved by our customers, crafted to perfection
                </p>
              </div>
              <Link
                to="/shop"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {bestSellers.map((item, idx) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: idx * 0.1, duration: 0.6 }}
                  className="flex flex-col bg-background rounded-2xl overflow-hidden shadow-soft hover:shadow-soft-hover transition-shadow duration-300"
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <Button className="w-full bg-primary hover:bg-[#3d4a2f] text-primary-foreground rounded-full transition-colors mt-auto">
                      Select Size
                    </Button>
                  </div>
                </motion.div>
        ...
        {/* CRAFTED TO LAST FOREVER SECTION */}
        <section className="py-24 bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 auto-rows-[200px] sm:auto-rows-[220px]">
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                transition={{ delay: 0.1 * 0.1, duration: 0.6 }}
                className="rounded-2xl overflow-hidden bg-card"
              >
                <img
                  src={galleryImages[1]}
                  alt="Inspired space 2"
                  className="w-full h-full object-cover transition-transform duration-700 hover:scale-105"
                />
              </motion.div>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                transition={{ delay: 0.2 * 0.1, duration: 0.6 }}
                className="rounded-2xl overflow-hidden bg-card"
              >
                <img
                  src={galleryImages[2]}
                  alt="Inspired space 3"
                  className="w-full h-full object-cover transition-transform duration-700 hover:scale-105"
                />
              </motion.div>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                transition={{ delay: 0.3 * 0.1, duration: 0.6 }}
                className="rounded-2xl overflow-hidden bg-card"
              >
                <img
                  src={galleryImages[3]}
                  alt="Inspired space 4"
                  className="w-full h-full object-cover transition-transform duration-700 hover:scale-105"
                />
              </motion.div>

              {/* Item 5 - Empty for aesthetic balance */}
              <motion.div
                initial={{ opacity: 0, scale: 0.95 }}
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                transition={{ delay: 0.4 * 0.1, duration: 0.6 }}
